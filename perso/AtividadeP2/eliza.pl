...
sr([bye|X], [goodbye|Y],X,Y).
sr([farewell|X], [goodbye|Y],X,Y).
...
rules([[should,0],[
		[1,[_,should,i,Y],0,
			[why,do,you,want,me,to,Y,?],
			[equal,[what,0]],
			[you,think,it,is,a,good,idea,that,'I',Y,?],
			[man,up,and,Y,with,me,.]],
		[2,[_,should,you,Y],0,
			[yes,',',why,not,Y,all,day,.],
			['I',do,not,know,',',should,you,?],
		              [perhaps,you,should,Y,.],
			[equal,[what,0]]]]]).

rules([[goodbye,0],[
		[1,[_],0,
			[why,are,you,leaving,?],
			[do,not,leave,',','I',love,you,.],
			[goodbye,see,you,later,.],
			[we,had,a,nice,chat,',','I',hope,we,can,talk,again,.]]]]).
